        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="container-fluid m-2 text-center">
                    <img src="{{ $product->packageimage }}" class="img-fluid img-thumbnail d-inline-block" width='200'
                        height='100'>
                ...
                {{ Form::open(['route' => ['review.store', $product->id] ]) }}
                <div class="border border-secondary rounded mx-5 my-1">
                    ...
                    <div class="d-grid gap-4 col-6 mx-auto m-4">
                        {{ Form::button('<i class="fa-solid fa-file"></i> レビューを送信', ['class' => "btn
                        btn-light",'type' =>
                        'submit']) }}
                    </div>
